...
// Navegadores
if (is.ie()) {$('body').addClass('browser-ie');}
if (is.edge()) {$('body').addClass('browser-edge');}
if (is.chrome()) {$('body').addClass('browser-chrome');}
if (is.firefox()) {$('body').addClass('browser-firefox');}
if (is.opera()) {$('body').addClass('browser-opera');}
if (is.safari()) {$('body').addClass('browser-safari');}

// SO / Device / Touch
if (is.ios()) {$('body').addClass('so-ios');}
if (is.iphone()) {$('body').addClass('so-iphone');}
if (is.ipad()) {$('body').addClass('so-ipad');}
if (is.android()) {$('body').addClass('so-android');}
if (is.androidPhone()) {$('body').addClass('so-androidPhone');}
if (is.androidTablet()) {$('body').addClass('so-androidTablet');}
if (is.blackberry()) {$('body').addClass('so-blackberry');}
if (is.windowsPhone()) {$('body').addClass('so-windowsPhone');}
if (is.windowsTablet()) {$('body').addClass('so-windowsTablet');}
if (is.windows()) {$('body').addClass('so-windows');}
if (is.mac()) {$('body').addClass('so-mac');}
if (is.linux()) {$('body').addClass('so-linux');}
if (is.desktop()) {$('body').addClass('so-desktop');}
if (is.mobile()) {$('body').addClass('so-mobile');}
if (is.tablet()) {$('body').addClass('so-tablet');}
if (is.touchDevice()) {$('body').addClass('so-touchDevice');}

// Online / Offline
// if (is.online()) {$('body').addClass('on-off-online');}
// if (is.offline()) {$('body').addClass('on-off-offline');}